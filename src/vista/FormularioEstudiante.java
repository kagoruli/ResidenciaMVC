...
public class FormularioEstudiante extends VBox {
    ...
    public FormularioEstudiante() {
        ...
        Label titulo = new Label("AGREGAR ESTUDIANTE");
        ...
        formulario.add(createLabel("NÚMERO DE CONTROL"), 0, rowIndex);
        TextField txtControl = createTextField();
        formulario.add(txtControl, 1, rowIndex++);
        ...
        btnAceptar.setOnAction(e -> {
            String resultado = ControladorEstudiante.registrarEstudiante(
                txtNombre.getText(),
                txtPaterno.getText(),
                txtMaterno.getText(),
                txtEmail.getText(),
            ...
            if (resultado.startsWith("ÉXITO:")) {
                ...
                mostrarAlerta(Alert.AlertType.INFORMATION, "Estudiante agregado exitosamente",
                        "Usuario: " + txtControl.getText() + "\nContraseña: " + contrasena);
                txtNombre.clear();
                txtPaterno.clear();
                txtMaterno.clear();
                txtControl.clear();
